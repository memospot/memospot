...
onMount(async () => {
	...
	if (input.theme !== ("system" as Theme)) {
...
<div class="space-y-4 w-full">
  ...
  <Setting name={m.settingsViewTheme()} desc={m.settingsViewThemeDescription()}>
    <Select.Root selected={selectedTheme} onSelectedChange={updateTheme}>
      <Select.Trigger class="ml-1 w-52">
        <Select.Value placeholder={m.settingsViewTheme()} />
      </Select.Trigger>
      <Select.Content>
        <Select.Item value="system">
          {themeNames.system}<LightningBolt
  ...
  <Setting name={m.settingsViewLanguage()} desc={m.settingsViewLanguageDescription()}>
    <Select.Root
      selected={selectedLanguageTag}
      onSelectedChange={updateLanguage}
    >
      <Select.Trigger class="ml-2 w-64">
        <Select.Value placeholder={m.settingsViewLanguage()} />
      </Select.Trigger>
      <Select.Content>
        <Select.Item value="system">
          {m.settingsViewSystem()}
  ...
  <Setting name={m.settingsViewResizable()} desc={m.settingsViewResizableDescription()}>
    <Switch
  ...
  <Setting name={m.settingsViewCentered()} desc={m.settingsViewCenteredDescription()}>
    <Switch
  ...
  <Setting name={m.settingsViewMaximized()} desc={m.settingsViewMaximizedDescription()}>
    <Switch
  ...
  <Setting name={m.settingsViewFullscreen()} desc={m.settingsViewFullscreenDescription()}>
    <Switch
