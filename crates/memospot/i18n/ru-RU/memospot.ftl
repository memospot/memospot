...
appmenu-browse-downloads-directory = &Просмотреть каталог загрузок…
...
dialog-update-manually-prompt =
    Не удалось автоматически обновиться до версии { $version }:
...
error-invalid-server-url =
    Недопустимый URL удалённого сервера:
    { $url }
...
panic-backup-directory-is-a-file =
    Каталог резервной копии существует как файл!
    { $dir }
panic-backup-directory-is-not-writable =
    Каталог резервной копии недоступен для записи!
    { $dir }
panic-config-error =
    Пожалуйста, исправьте файл конфигурации
    вручную и перезапустите приложение.
panic-config-is-not-a-file =
    Указанный путь конфигурации является каталогом.
    Он должен быть файлом!
    { $path }
panic-config-is-not-writable =
    Файл конфигурации недоступен для записи!
    { $file }
...
panic-database-file-is-not-writable =
    Файл базы данных недоступен для записи!
    { $file }
...
panic-log-config-reset-error =
    Не удалось сбросить файл конфигурации журнала:
    { $file }
...
panic-unable-to-create-backup-directory =
    Не удалось создать каталог резервной копии!
    { $dir }
...
panic-unable-to-resolve-custom-data-directory =
    Не удалось разрешить пользовательский каталог данных Memos!
    { $dir }
...
prompt-config-error-message =
    Не удалось разобрать файл конфигурации:
...
prompt-install-webview-message =
    WebView *обязателен* для работы этого приложения,
